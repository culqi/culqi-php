...
const ERROR_PARAMETER_AMOUNT = "El campo 'amount' es inválido o está vacío, debe tener un valor numérico.";
...
const INVALID_INITIAL_CYCLES_AMOUNT = "El campo 'initial_cycles.amount' es inválido o está vacío, debe tener un valor numérico.";
...
const INVALID_IMAGE = "El campo 'image' es inválido o está vacío. El valor debe ser una cadena y debe ser una URL válida.";
